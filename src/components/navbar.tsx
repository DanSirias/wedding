          ...
          {idToken ? (
            ...
            <Box sx={{ flexGrow: 0, display: { xs: "block", md: "flex" } }}>
              <Typography display="flex" alignItems="center" textAlign="center">
                ...
                <Link
                  component={RouterLink}
                  to="https://siriaswedding.auth.us-east-1.amazoncognito.com/oauth2/authorize?client_id=5bfvpm9fvjgbh5c2s32oiv9d6h&response_type=token&scope=email+openid+phone+profile&redirect_uri=https%3A%2F%2Fwww.siriaswedding.com%2Fcallback"
